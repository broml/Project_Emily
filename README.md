...
Contributions to the Emily project are more than welcome! Whether it's squashing bugs, improving the code, or expanding the hardware design, feel free to fork this repository and submit your Pull Requests. If you encounter any issues or have ideas for new features, please open an Issue first so we can discuss it.
